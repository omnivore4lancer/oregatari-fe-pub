...
export function TrendingIcon({ size = 15 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MessageIcon({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ComicIcon({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
