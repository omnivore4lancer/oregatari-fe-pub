    ...
    <div className="shrink-0 bg-white border-b border-gray-200">
      ...
      <div className="h-11 flex items-center px-4 gap-3">
        ...
        <Link
          ...
          className="flex items-center gap-1 px-2.5 py-1 text-[12px] text-gray-500 hover:text-gray-800 no-underline border border-gray-200 rounded-md hover:bg-gray-50 transition-colors"
        >
